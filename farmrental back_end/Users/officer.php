        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header shadow d-block" style="background-color: black">
                    <div class="row">
                        <div class="col-md-10">
                            <h3 style="color: white;font-size: 18px;">Oficers Details Table </h3>
                        </div>
                        ...
                        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    // SQL query to join the tables and fetch users with the role 'Farmer'
                                    $select_users = "
...
function confirmDelete(Id) {
    if (confirm("Are you sure you want to delete?")) {
        window.location.href = "./delete1.php?user_id=" + Id;
    }
}
</script>