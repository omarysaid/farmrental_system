...
if ($logged_in_user_role == 'ExtensionOfficer') {
    $select = "
        ...
        WHERE 
            f.status = 1 AND u.district = '$logged_in_user_district'
    ";
} else {
    $select = "
        SELECT 
...
?>
                                <tr>
                                    ...
                                    <td style="color: green;">
                                        <?php echo '<i class="fa fa-check"></i>'; ?><b>Approved</b>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span>
                                            <a href="./update_approvedfarm.php?farm_id=<?php echo $row['farm_id'] ?>">
