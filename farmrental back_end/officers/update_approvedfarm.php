...
if (isset($_GET['farm_id'])) {
    ...
    $select_farm = "SELECT farm_image, status, fertile FROM farms WHERE farm_id = '$farm_id'";
        ...
        <div class="col-md-12">
            <div class="card" style="min-height: 484px;">
                <div class="card-header shadow" style="background-color: black;">
                    <h3 style="color: white;">Approve Farm Details</h3>
                </div>
                ...
                <div class="card-body shadow">
                    <form class="forms-sample" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="status" name="status"
                                    ...
                                    <option value="1" <?php echo ($farm['status'] == '1') ? 'selected' : ''; ?>>Approved
                                    </option>
                                    <option value="0" <?php echo ($farm['status'] == '0') ? 'selected' : ''; ?>>Not
                                        Approved</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="fertile" class="col-sm-2 col-form-label">Fertile</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="fertile" placeholder="Enter your description here"
                                    name="fertile"
                                    style="height: 200px; border-color:black; border-radius:5px;"><?php echo htmlspecialchars($farm['fertile']); ?></textarea>
                            </div>
                        </div>
